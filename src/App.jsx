...
const CHAPTERS = [
  {
    ...
    titleLines: ['Never Stop.', 'Never Settle.'],
...
const TRANSLATIONS = {
  en: {
    ...
    // Chapters
    chapters: {
      hero:     { label: 'BEJOICE AI ENGINE',  titleLines: ['Never Stop.', 'Never Settle.'],    body: "Wars, storms, port strikes — none of it stops your cargo. Our AI predicts every disruption, reroutes in seconds, and delivers at the lowest cost. Every time." },
